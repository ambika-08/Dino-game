...
{ 
    ...
    // Clear the obstacle's previous position
    if (obstaclePosition > 0) {
        moveTo(74 - obstaclePosition + 1, 20); 
        printf("   "); 
        moveTo(74 - obstaclePosition + 1, 21); 
        printf("   "); 
        moveTo(74 - obstaclePosition + 1, 22); 
        printf("   "); 
        moveTo(74 - obstaclePosition + 1, 23); 
        printf("   "); 
    }
